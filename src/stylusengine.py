...
def stSetGlobals(pxmlGlobals):
    return _stylusengine.stSetGlobals(pxmlGlobals)
stSetGlobals = _stylusengine.stSetGlobals

def stSetTraceAttempt(iAttempt):
    return _stylusengine.stSetTraceAttempt(iAttempt)
stSetTraceAttempt = _stylusengine.stSetTraceAttempt

def stGetTraceAttempt(piAttempt):
    return _stylusengine.stGetTraceAttempt(piAttempt)
stGetTraceAttempt = _stylusengine.stGetTraceAttempt

def stExecutePlanForMutations(pxmlPlan, iTrialFirst, cTrials, pfnStatus, cStatusRate):
    return _stylusengine.stExecutePlanForMutations(pxmlPlan, iTrialFirst, cTrials, pfnStatus, cStatusRate)
...
class ST_TRIALVALUE(_object):
    ...
    if _newclass:
        _iTrial = _swig_property(_stylusengine.ST_TRIALVALUE__iTrial_get)
    __swig_getmethods__["_nValue"] = _stylusengine.ST_TRIALVALUE__nValue_get
    if _newclass:
        _nValue = _swig_property(_stylusengine.ST_TRIALVALUE__nValue_get)
...
class ST_TRIALROLLBACKS(_object):
    ...
    if _newclass:
        _iTrial = _swig_property(_stylusengine.ST_TRIALROLLBACKS__iTrial_get)
    __swig_getmethods__["_cRollbacks"] = _stylusengine.ST_TRIALROLLBACKS__cRollbacks_get
    if _newclass:
        _cRollbacks = _swig_property(_stylusengine.ST_TRIALROLLBACKS__cRollbacks_get)
...
class ST_TRIALSIZE(_object):
    ...
    if _newclass:
        _iTrial = _swig_property(_stylusengine.ST_TRIALSIZE__iTrial_get)
    __swig_getmethods__["_cbBases"] = _stylusengine.ST_TRIALSIZE__cbBases_get
    if _newclass:
        _cbBases = _swig_property(_stylusengine.ST_TRIALSIZE__cbBases_get)
...
class ST_ATTEMPTS(_object):
    ...
    if _newclass:
        _cConsidered = _swig_property(_stylusengine.ST_ATTEMPTS__cConsidered_get)
    __swig_getmethods__["_cAttempted"] = _stylusengine.ST_ATTEMPTS__cAttempted_get
    if _newclass:
        _cAttempted = _swig_property(_stylusengine.ST_ATTEMPTS__cAttempted_get)
    __swig_getmethods__["_cAccepted"] = _stylusengine.ST_ATTEMPTS__cAccepted_get
    if _newclass:
        _cAccepted = _swig_property(_stylusengine.ST_ATTEMPTS__cAccepted_get)
    __swig_getmethods__["_cbBases"] = _stylusengine.ST_ATTEMPTS__cbBases_get
    if _newclass:
        _cbBases = _swig_property(_stylusengine.ST_ATTEMPTS__cbBases_get)
...
_stylusengine.STGS_ALIVE_swigconstant(_stylusengine)
STGS_ALIVE = _stylusengine.STGS_ALIVE

_stylusengine.STGS_COMPILED_swigconstant(_stylusengine)
STGS_COMPILED = _stylusengine.STGS_COMPILED

_stylusengine.STGS_COMPILING_swigconstant(_stylusengine)
STGS_COMPILING = _stylusengine.STGS_COMPILING

_stylusengine.STGS_DEAD_swigconstant(_stylusengine)
STGS_DEAD = _stylusengine.STGS_DEAD

_stylusengine.STGS_INVALID_swigconstant(_stylusengine)
STGS_INVALID = _stylusengine.STGS_INVALID

_stylusengine.STGS_LOADING_swigconstant(_stylusengine)
STGS_LOADING = _stylusengine.STGS_LOADING

_stylusengine.STGS_MUTATING_swigconstant(_stylusengine)
STGS_MUTATING = _stylusengine.STGS_MUTATING

_stylusengine.STGS_RECORDING_swigconstant(_stylusengine)
STGS_RECORDING = _stylusengine.STGS_RECORDING

_stylusengine.STGS_ROLLBACK_swigconstant(_stylusengine)
STGS_ROLLBACK = _stylusengine.STGS_ROLLBACK

_stylusengine.STGS_RESTORING_swigconstant(_stylusengine)
STGS_RESTORING = _stylusengine.STGS_RESTORING

_stylusengine.STGS_SCORED_swigconstant(_stylusengine)
STGS_SCORED = _stylusengine.STGS_SCORED

_stylusengine.STGS_SCORING_swigconstant(_stylusengine)
STGS_SCORING = _stylusengine.STGS_SCORING

_stylusengine.STGS_SPAWNING_swigconstant(_stylusengine)
STGS_SPAWNING = _stylusengine.STGS_SPAWNING

_stylusengine.STGS_VALIDATED_swigconstant(_stylusengine)
STGS_VALIDATED = _stylusengine.STGS_VALIDATED

_stylusengine.STGS_VALIDATING_swigconstant(_stylusengine)
STGS_VALIDATING = _stylusengine.STGS_VALIDATING

_stylusengine.STGS_MAX_swigconstant(_stylusengine)
STGS_MAX = _stylusengine.STGS_MAX

_stylusengine.STGT_NONE_swigconstant(_stylusengine)
STGT_NONE = _stylusengine.STGT_NONE

_stylusengine.STGT_COMPILATION_swigconstant(_stylusengine)
STGT_COMPILATION = _stylusengine.STGT_COMPILATION

_stylusengine.STGT_VALIDATION_swigconstant(_stylusengine)
STGT_VALIDATION = _stylusengine.STGT_VALIDATION

_stylusengine.STGT_SCORE_swigconstant(_stylusengine)
STGT_SCORE = _stylusengine.STGT_SCORE

_stylusengine.STGT_MUTATION_swigconstant(_stylusengine)
STGT_MUTATION = _stylusengine.STGT_MUTATION

_stylusengine.STGT_DURATION_swigconstant(_stylusengine)
STGT_DURATION = _stylusengine.STGT_DURATION

_stylusengine.STGT_ROLLBACK_swigconstant(_stylusengine)
STGT_ROLLBACK = _stylusengine.STGT_ROLLBACK

_stylusengine.STGT_FITNESS_swigconstant(_stylusengine)
STGT_FITNESS = _stylusengine.STGT_FITNESS

_stylusengine.STGT_CALLBACK_swigconstant(_stylusengine)
STGT_CALLBACK = _stylusengine.STGT_CALLBACK

_stylusengine.STGR_NONE_swigconstant(_stylusengine)
STGR_NONE = _stylusengine.STGR_NONE

_stylusengine.STGR_STROKES_swigconstant(_stylusengine)
STGR_STROKES = _stylusengine.STGR_STROKES

_stylusengine.STGR_MEASUREMENT_swigconstant(_stylusengine)
STGR_MEASUREMENT = _stylusengine.STGR_MEASUREMENT

_stylusengine.STGR_COST_swigconstant(_stylusengine)
STGR_COST = _stylusengine.STGR_COST

_stylusengine.STGR_FITNESS_swigconstant(_stylusengine)
STGR_FITNESS = _stylusengine.STGR_FITNESS

_stylusengine.STGR_SCORE_swigconstant(_stylusengine)
STGR_SCORE = _stylusengine.STGR_SCORE

_stylusengine.STGR_STROKE_swigconstant(_stylusengine)
STGR_STROKE = _stylusengine.STGR_STROKE

_stylusengine.STGR_CHANGE_swigconstant(_stylusengine)
STGR_CHANGE = _stylusengine.STGR_CHANGE

_stylusengine.STGR_COPY_swigconstant(_stylusengine)
STGR_COPY = _stylusengine.STGR_COPY

_stylusengine.STGR_DELETE_swigconstant(_stylusengine)
STGR_DELETE = _stylusengine.STGR_DELETE

_stylusengine.STGR_INSERT_swigconstant(_stylusengine)
STGR_INSERT = _stylusengine.STGR_INSERT

_stylusengine.STGR_TRANSPOSE_swigconstant(_stylusengine)
STGR_TRANSPOSE = _stylusengine.STGR_TRANSPOSE

_stylusengine.STGR_TRIALS_swigconstant(_stylusengine)
STGR_TRIALS = _stylusengine.STGR_TRIALS

_stylusengine.STGR_ATTEMPTS_swigconstant(_stylusengine)
STGR_ATTEMPTS = _stylusengine.STGR_ATTEMPTS

_stylusengine.STGR_LIMIT_swigconstant(_stylusengine)
STGR_LIMIT = _stylusengine.STGR_LIMIT

_stylusengine.STGR_MAXIMUM_swigconstant(_stylusengine)
STGR_MAXIMUM = _stylusengine.STGR_MAXIMUM

_stylusengine.STGR_MINIMUM_swigconstant(_stylusengine)
STGR_MINIMUM = _stylusengine.STGR_MINIMUM

_stylusengine.STGR_TERMINATED_swigconstant(_stylusengine)
STGR_TERMINATED = _stylusengine.STGR_TERMINATED

def stGetGenomeTermination(pgt, pgr, pszTermination, pcchTermination):
    return _stylusengine.stGetGenomeTermination(pgt, pgr, pszTermination, pcchTermination)
stGetGenomeTermination = _stylusengine.stGetGenomeTermination

def stSetSeed(seed):
    return _stylusengine.stSetSeed(seed)
stSetSeed = _stylusengine.stSetSeed

def errorToString(rc):
    return _stylusengine.errorToString(rc)
errorToString = _stylusengine.errorToString

def errorIsType(rc, type):
    return _stylusengine.errorIsType(rc, type)
...
def setGlobals(pszGlobals):
    return _stylusengine.setGlobals(pszGlobals)
setGlobals = _stylusengine.setGlobals

def setScope(pszURLHan, pszURLXMLSchema):
    return _stylusengine.setScope(pszURLHan, pszURLXMLSchema)
...
def setLogLevel(cRate, pszLevel, fEcho, fLong):
    return _stylusengine.setLogLevel(cRate, pszLevel, fEcho, fLong)
setLogLevel = _stylusengine.setLogLevel

def setLogFile(filename):
    return _stylusengine.setLogFile(filename)
...
def setTrace(pvecRegions, tlFlow, tlData, iTrial, iAttempt):
    return _stylusengine.setTrace(pvecRegions, tlFlow, tlData, iTrial, iAttempt)
...
def setRecordRate(cRate, pvecDetail, pszDirectory, fRecordHistory):
    return _stylusengine.setRecordRate(cRate, pvecDetail, pszDirectory, fRecordHistory)
setRecordRate = _stylusengine.setRecordRate

def setGenome(pszGenome, pszAuthor):
    return _stylusengine.setGenome(pszGenome, pszAuthor)
setGenome = _stylusengine.setGenome

def getGenome(pvecDetail):
    return _stylusengine.getGenome(pvecDetail)
...
def executePlanForMutations(pszPlan, iTrialFirst, cTrials, callback):
    return _stylusengine.executePlanForMutations(pszPlan, iTrialFirst, cTrials, callback)
executePlanForMutations = _stylusengine.executePlanForMutations
class STATISTICS(ST_STATISTICS):
    __swig_setmethods__ = {}
    for _s in [ST_STATISTICS]:
...
def setSeed(seed):
    return _stylusengine.setSeed(seed)
